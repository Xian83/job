...
<div class="col-md-6" align="center">
	...
	<div class="compare_fixname" align="left">
		<div class="name left"><span class="label label-danger"  style="font-size: 10px;"><b>${score01.CMPN_NM }</b></span><br/> </div>
	</div> 
	<br/>
...
<div class="col-md-6" align="center">
 ...
 <div class="compare_fixname" align="right">
		<div class="name right"><span class="label label-primary" style="font-size: 10px;"><b>${score02.CMPN_NM }</b></span><br/></div>
	</div> 
	<br/>
