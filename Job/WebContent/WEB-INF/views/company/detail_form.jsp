...
<div class="container-fluid"
		...
		<div class="col-md-8">
			<div class="row content">
				...
				<div class="col-sm-9 sidenav">
					...
					<c:choose>
					<c:when test="${score.SLAVE_SCORE ==null}">
						<p>재직자점수 : ${score.SLAVE_SCORE=0 }점(해당회사의 정보가 입력되지 않았습니다.)</p>
					</c:when>
					<c:otherwise>
					<p>재직자점수 : ${score.SLAVE_SCORE }점</p>
					</c:otherwise>
				</c:choose>
					<div
						style="CLEAR: both; PADDING-RIGHT: 0px; PADDING-LEFT: 0px; BACKGROUND: url(/spare.gif) 0px 0px; FLOAT: left; PADDING-BOTTOM: 0px; MARGIN: 0px; WIDTH: 90px; PADDING-TOP: 0px; HEIGHT: 18px;">
						<p
							style="WIDTH: ${score.SLAVE_SCORE }%; PADDING-RIGHT:0px;	PADDING-LEFT:0px;	BACKGROUND: url(/star.gif) 0px 0px;	PADDING-BOTTOM: 0px;	MARGIN: 0px;	PADDING-TOP: 0px;	HEIGHT: 18px;">
						</p>
					</div>
				</div>
			</div>
	...
	<div class="col-md-4">
		...
		<table class="table table-bordered" style="text-align: center;">
			...
			<tbody>
				<tr>
					<td><fmt:formatNumber value="${salary.AVG_SALARY }"
							groupingUsed="true" />원</td>
					<td><fmt:formatNumber value="${salary.ROOKIE_SALARY }"
							groupingUsed="true" />원</td>
				</tr>
		</table>
		<div align="center">
	...
	<script type="text/javascript">
			...
			function drawChart() {
				var data = google.visualization.arrayToDataTable([
						[ 'Year', '${score.CMPN_NM }' ],
						[ '2013', ${info01.employee[0]}],
						[ '2014', ${info01.employee[1]} ],
						[ '2015', ${info01.employee[2]} ] 
				]);
			...
			<div class="col-md-12">
				<table class="table table-bordered">
					...
					<tbody>
						...
						<tr style="height: 30px">
							<td colspan="1" rowspan="1"
								style="vertical-align: middle; text-align: center">평균</td>
							<td colspan="1" rowspan="1"
