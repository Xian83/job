...
<div align="center">
	<h1>약관</h1>
	이용약관, 개인정보 수집 및 이용 약관(필수)에 모두 동의합니다. <input type="checkbox" id="chkAll" />
	<hr />
	<div class="form-group" style="height: 200;" id="rule01">
	...
	<hr />
	<div class="form-group" style="height: 200;" id="rule02">
	...
	<hr />
	<button disabled id="btn">다음 단계로</button>
</div>
<script>
