                ...
                <div class="tabSearchList">
                    <ul>
                    		<li data-no="167">
                                ...
                                <div class="searchListData"><ul>잡코리아는 어떤 취업 사이트보다도 상세한 검색을 제공하고 있습니다.<br/><br/>채용정보 검색에서는 업·직종, 성별, 학력, 근무지역, 급여정도, 경력, 고용형태, 키워드 등의 조건을 동시에 지정하여 검색할 수 있습니다. <br/><br/>채용정보 검색을 통해서 가장 적합한 채용정보를 찾으시기 바랍니다<br/><br/><a href="http://www.jobkorea.co.kr/List_GI/GI_Search.asp" target="n"><font color="#0061f7"><b>☞ 채용정보 검색</b></font></a></ul></div>
                            </li>
                            <li data-no="318">
